...
<div id="proc" class="col s12" style="display: block;">
    <div>
        <div class="row">
            <div class="col s11">
                <h5 class="left-align">Découvrez nos séléctions de Processeurs !</h5>
            </div>
        </div>
        <div class="row">
            <ul class="collapsible">
                <?php foreach($product["products"]["stockPROC"] as $item): ?>
                    ...
                    <div class="collapsible-body">
                        ...
                        <div class="row"  style="margin-top: 70px; margin-left: auto; margin-right: 0;">
                            ...
                            <div class="col" style="margin-top: 30px;">
                                <i onclick="changeQuantity('+', 'product_<?=$item["id"]?>_quantity', 'proc')" style="border: black 1px solid; border-radius: 6px; font-size: 15px;" class="material-icons">add</i>
                            </div>
                            ...
                            <div class="col" style="margin-top: 30px;">
                                <i onclick="changeQuantity('-', 'product_<?=$item["id"]?>_quantity', 'proc')" style="border: black 1px solid; border-radius: 6px; font-size: 15px;" class="material-icons">remove</i>
                            </div>
                        </div>
                        <div class="row" style="margin-top: 20px;">
                            <div class="col offset-s7">
                                <a style="background-color: #006fac;" class="waves-effect waves-light btn" onclick="hideStock('<?=$item["id"]?>'); showCurrentStock('proc', '<?=$item["id"]?>');"><i class="material-icons right">inventory_2</i>Voir le stock</a>
                            </div>
                            <div class="col">
